...
exports.makeMomentumPTB = makeMomentumPTB;
const utils_1 = require("@mysten/sui/utils");
const config_1 = require("../config");
function makeMomentumPTB(txb, poolId, pathTempCoin, amount, a2b, typeArguments) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [receive_a, receive_b, flash_receipt] = txb.moveCall({
            target: `${config_1.AggregatorConfig.momentumPackageId}::trade::flash_swap`,
            typeArguments,
            arguments: [
                poolObject,
                txb.pure.bool(a2b),
                ...
                txb.object(config_1.AggregatorConfig.momentumVersionId),
            ],
        });
        txb.moveCall({
        ...
        const [coinADebt, coinBDebt] = txb.moveCall({
            target: `${config_1.AggregatorConfig.momentumPackageId}::trade::swap_receipt_debts`,
            typeArguments: [],
        ...
        txb.moveCall({
            target: `${config_1.AggregatorConfig.momentumPackageId}::trade::repay_flash_swap`,
            typeArguments,
            arguments: [
                poolObject,
                flash_receipt,
        ...
        txb.moveCall({
            target: `${config_1.AggregatorConfig.momentumSlippageCheckPackageId}::slippage_check::assert_slippage`,
            typeArguments,
