...
export declare function getCoins(client: SuiClient, address: string, coinType?: any): Promise<import("@mysten/sui/client").PaginatedCoins>;
...
export declare function buildSwapPTBFromQuote(userAddress: string, txb: Transaction, minAmountOut: number, coinIn: TransactionResult, quote: Quote, referral?: number, ifPrint?: boolean, apiKey?: string, swapOptions?: SwapOptions): Promise<TransactionResult>;
