...
function getAddressPortfolio(address_2) {
    return __awaiter(this, arguments, void 0, function* (address, prettyPrint = true, client, decimals, tokenFilter) {
        ...
        yield Promise.all(filteredTokens.map((poolKey) => __awaiter(this, void 0, void 0, function* () {
...
function getUserState(client, address) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const config = yield (0, address_1.getConfig)();
        const tx = new transactions_1.Transaction();
        const result = yield moveInspect(tx, client, '0xcda879cde94eeeae2dd6df58c9ededc60bcf2f7aedb79777e47d95b2cfb016c2', `${config.uiGetter}::getter::get_user_state`, [
            tx.object(config.StorageId),
